...
app.get('/usuario', verificaToken, (req, res) => {
    ...
    Usuario.find({ estado: true }, 'nombre email role estado google img') //te excluye todo lo que no está entre ''
        .skip(desde) //se salta los primeros 5
        .limit(limite) // te muestra los 5
        .exec((err, usuarios) => {
            ...
            Usuario.count({ estado: true }, (err, conteo) => {
                //el .count debe tener el mismo filtro que el find
                res.json({
                    ok: true,
                    usuarios: usuarios,
                    cuantos: conteo
...
app.post('/usuario', [verificaToken, verificarAdminRol], (req, res) => {
    ...
    usuario.save((err, usuarioDB) => {
        ...
        // usuarioDB.password = null; //para no devolver la contraseña
